`timescale 1ns/1ps
module board_top_tb;
    localparam integer MAX_RESPONSE = 64660; // 144 header + 336*48*4 final raw + CRC32
    ...
    task automatic packet_exchange;
        begin
            ...
            $display("SCU_BOARD_PACKET transaction=%0d bytes=%0d jobs=%0d publications=%0d stripe_acks=%0d",
    ...
    initial begin
        ...
        $display("SCU_BOARD_TOP_COMPLETE transactions=%0d jobs=%0d publications=%0d stripe_acks=%0d resets=%0d period_ns=40 uart_baud=1000000 vendor_unisims=true",
