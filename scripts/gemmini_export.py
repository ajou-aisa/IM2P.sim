...
REQUIRED_SOURCE_FILES: Final = (
    ...
    "sim/cycle/execution_lifecycle.py", "sim/cycle/execution_lifecycle_cli.py", "sim/cycle/execution_stream.py",
    ...
    "sim/cycle/corpus-authority-v3.json",
    ...
    "docs/EVALUATION_EXECUTION_IR.md",
) + HARDWARE_PATHS
