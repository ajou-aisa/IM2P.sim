...
SOURCE_SUFFIXES: Final = frozenset({
    ".bsv", ".c", ".cc", ".cmake", ".cpp", ".h", ".hpp", ".inc", ".json", ".md", ".patch", ".properties",
...
RMD_LLAMA_SOURCES: Final = (
    ...
    "ggml/src/ggml-gemmini/residual/rmd/rmd-run-aware.hpp",
...
REQUIRED_SOURCE_FILES: Final = (
    ...
    "frontend/include/im2p_cpu_functional.hpp", "frontend/include/im2p_cycle_sim.hpp",
    ...
    "scripts/evaluation_clock.py", "scripts/evaluation_clock_contract.py", "scripts/gemmini_board.py",
    "scripts/evaluation_ooc.py", "scripts/evaluation_ooc_policy.py",
    "scripts/evaluation_ooc_rtl.py", "scripts/evaluation_ooc_report.py",
    "config/evaluation_ooc_policy.json", "fpga/gemmini_hp1/flow/evaluation_ooc.tcl",
    ...
    "sim/cycle/npu_trace.py", "sim/cycle/npu_trace_schema.py",
    "sim/cycle/npu_trace_runs.py", "sim/cycle/npu_trace_integrity.py",
    "sim/cycle/npu_trace_calls.py", "sim/cycle/npu_trace_hosts.py",
    "sim/cycle/run_aware_certificate.py",
    "sim/cycle/run_aware_production_evidence.py",
    "sim/cycle/reconstruct.py", "sim/cycle/reconstruct_cpu.py",
    "sim/cycle/reconstruct_graph.py", "sim/cycle/reconstruct_npu.py",
    "sim/cycle/reconstruct_timing.py",
    "sim/cycle/execution_adapter.py", "sim/cycle/execution_cli.py",
    "sim/cycle/execution_application.py", "sim/cycle/execution_cycle_provider.py",
    "sim/cycle/execution_lifecycle.py", "sim/cycle/execution_forced_lifecycle.py",
    "sim/cycle/execution_lifecycle_cli.py", "sim/cycle/execution_pipeline.py",
    "sim/cycle/execution_pipeline_contract.py", "sim/cycle/execution_stream.py",
    "sim/cycle/reconstruct_pairing.py", "sim/cycle/collect.py",
    "sim/cycle/collection_build.py", "sim/cycle/collection_native.py", "sim/cycle/input_snapshot.py",
    "sim/cycle/execution_ir.py", "sim/cycle/execution_services.py", "sim/cycle/scheduler.py",
    "sim/cycle/scheduler_sqlite.py", "sim/cycle/service_certificate.py",
    "sim/cycle/production_sequence_certificate.py",
    "sim/cycle/production_sequence_evidence.py",
    "sim/cycle/production_sequence_corpus.json",
    ...
    "sim/cycle/corpus-authority-v3.json", "sim/cycle/corpus-authority-v4.json",
    "scripts/gemmini_rtl_build_binding.py",
    "sim/tests/cycle/probe.cpp", "sim/tests/cycle/test_cycle_model.cpp",
    "sim/tests/cycle/test_service_model.cpp",
    ...
    "sim/tests/cycle/production_run_work.py",
    "sim/tests/cycle/production_run_aware_corpus.json",
    "sim/tests/cycle/certify_production_run_aware.py",
    ...
    "sim/tests/cycle/service_certificate_corpus.json", "sim/tests/cycle/service_certificate_probe.cpp",
    ...
    "docs/GEMMINI_CYCLE_MODEL.md", "docs/VERIFICATION.md", "docs/EVALUATION_CLOCK.md",
    "docs/CORPUS_AUTHORITY_V4.md",
    "docs/EVALUATION_EXECUTION_IR.md", "docs/HP1_SERVICE_CERTIFICATE.md",
) + HARDWARE_PATHS
HOST_LLAMA_TRACE_OFF_SOURCES: Final = RMD_LLAMA_SOURCES + (
    "common/json.hpp",
    "ggml/src/ggml-gemmini-utils/CMakeLists.txt",
    "ggml/src/ggml-gemmini-utils/src/evaluation_metrics.cpp",
    "ggml/src/ggml-gemmini-utils/include/gemmini/evaluation_metrics.hpp",
...
def linux_instructions(dependencies: dict[str, JsonValue], trace_enabled: bool) -> str:
    ...
    lines.extend((
        ...
        "The minimum host includes the current metric utility translation unit with metric hooks OFF. The native evaluation runner, common evaluation-workload helper, root build-option resolver and scripts/eval workflows require a full candidate llama checkout; they are not a runnable full-model export contract here.",
        ...
        '(cd "$package/source" && python3 -m sim.cycle.execution_cli --help)',
        'python3 "$package/source/scripts/evaluation_clock.py" --help',
        "```",
        "",
        ...
        "The additive im2p_cycle_service.h API preserves result-ready versus resource-ready. Execution IR and clock-selection tooling are included, but export does not supply measured CPU/application service, a verified clock, sequential service certification, or a complete E2E dataset. Synthetic scheduler success is not reconstructed production latency.",
