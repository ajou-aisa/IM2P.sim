...
make rtl-one TOP=mkSynthA8W8D16 BUILD_DIR="$HOME/aisa-lab/build/im2p-legacy-rtl"
```
...
Source/profile identity remains part of cache validation. Generic current Gemmini synthesis is documented separately in `../SYNTHESIS.md`.
