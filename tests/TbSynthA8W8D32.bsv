...
function Vector#(32, Int#(A8AccumulatorWidth)) expectedRow(UInt#(1) row);
    Vector#(32, Int#(A8AccumulatorWidth)) expected = replicate(0);
...
module mkTbSynthA8W8D32(Empty);
    IM2PCoreIfc#(
        ...
        1,
        32,
        IntegerAccumulatorRows#(32, A8AccumulatorWidth),
        Int#(8),
        Int#(8),
        Int#(16),
    ...
    Reg#(Vector#(32, Int#(A8AccumulatorWidth))) observedRow0 <- mkRegU;
    ...
    rule checkResults (state == CheckRow0);
        Vector#(32, Int#(A8AccumulatorWidth)) observedRow1 = dut.readAccumulatorRowResponse;
        dut.consumeAccumulatorReadResponse;
