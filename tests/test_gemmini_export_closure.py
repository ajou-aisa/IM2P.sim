...
def test_required_source_closure_when_checksums_are_recomputed() -> None:
    ...
    with tempfile.TemporaryDirectory(prefix="gemmini-source-closure-") as directory:
        ...
        required = (
            ...
            "source/sim/cycle/execution_forced_lifecycle.py",
            "source/sim/cycle/execution_lifecycle_cli.py",
            "source/sim/cycle/execution_pipeline.py",
            "source/sim/cycle/execution_pipeline_contract.py",
            "source/sim/cycle/execution_stream.py",
            "source/sim/cycle/service_certificate.py",
            "source/sim/cycle/production_sequence_certificate.py",
            "source/sim/cycle/production_sequence_evidence.py",
            "source/sim/cycle/production_sequence_corpus.json",
            "source/sim/tests/cycle/service_boundary.py",
            "source/sim/tests/cycle/service_boundary_probe.cpp",
            "source/sim/tests/cycle/service_certificate_build.py",
            "source/sim/tests/cycle/service_certificate_corpus.json",
            "source/sim/tests/cycle/service_certificate_probe.cpp",
            "source/sim/tests/cycle/production_sequence_probe.cpp",
            "source/sim/tests/cycle/production_sequence_work.py",
            "source/sim/tests/cycle/production_tag_carry.py",
            "source/docs/HP1_SERVICE_CERTIFICATE.md",
            ...
            "source/sim/cycle/corpus-authority-v4.json",
            "source/docs/CORPUS_AUTHORITY_V4.md",
...
def test_relocated_run_headers_and_fixture_cli() -> None:
    ...
    with tempfile.TemporaryDirectory(prefix="gemmini-run-relocation-") as directory:
        ...
        for module in ("sim.cycle.execution_lifecycle_cli", "sim.cycle.execution_pipeline",
                       "sim.cycle.service_certificate", "sim.cycle.production_sequence_certificate",
                       "sim.tests.cycle.production_sequence_work",
                       "scripts.evaluation_ooc"):
            completed = subprocess.run(
